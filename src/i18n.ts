...
const dict = {
  cs: {
    ...
    accLink: "kde budeme spát →",
    footerNote: "Fotky uvidí novomanželé a hosté ve společné galerii.",
    forCouple: "pro novomanžele",
    // accommodation
    accTitle: "Kde budeme spát",
    accSubtitle: "Najděte své jméno",
    accSearch: "Hledat jméno…",
    accClear: "Vymazat hledání",
    accNoResults: "Nikoho jsme nenašli. Zkuste jen příjmení.",
    accSiteCaption: "Areál · klepněte na budovu",
    accSiteNote: "Orientační nákres — polohy budov jsou přibližné.",
    accOverview: "Zpět na přehled",
    accTapBed: "Klepněte na postel",
    accEmpty: "Zatím neobsazeno",
    accDouble: "Dvoulůžko",
    accSingle: "Jednolůžko",
    accWeddingBed: "Svatební lože",
    accDoNotDisturb: "Prosíme nerušit",
    accWeddingNote: "Tady spí novomanželé. Klepat jen s dortem.",
    accBed: (n: number) => `Postel ${n}`,
    accBeds: (n: number) => (n === 1 ? "1 lůžko" : n >= 2 && n <= 4 ? `${n} lůžka` : `${n} lůžek`),
    accFloors: (n: number) => (n === 1 ? "1 patro" : n >= 2 && n <= 4 ? `${n} patra` : `${n} pater`),
    accRooms: (n: number) => (n === 1 ? "1 pokoj" : n >= 2 && n <= 4 ? `${n} pokoje` : `${n} pokojů`),
    accSketchNote: "Půdorys nemáme — rozmístění postelí je orientační.",
    // gallery
  ...
  en: {
    ...
    accLink: "where we sleep →",
    footerNote: "Photos are visible to the newlyweds and guests in the shared gallery.",
    forCouple: "for the newlyweds",
    accTitle: "Where we sleep",
    accSubtitle: "Find your name",
    accSearch: "Search a name…",
    accClear: "Clear search",
    accNoResults: "No one found. Try just the surname.",
    accSiteCaption: "Grounds · tap a building",
    accSiteNote: "Schematic sketch — building positions are approximate.",
    accOverview: "Back to overview",
    accTapBed: "Tap a bed",
    accEmpty: "Not assigned yet",
    accDouble: "Double bed",
    accSingle: "Single bed",
    accWeddingBed: "Wedding bed",
    accDoNotDisturb: "Do not disturb",
    accWeddingNote: "The newlyweds sleep here. Knock only if you bring cake.",
    accBed: (n: number) => `Bed ${n}`,
    accBeds: (n: number) => (n === 1 ? "1 bed" : `${n} beds`),
    accFloors: (n: number) => (n === 1 ? "1 floor" : `${n} floors`),
    accRooms: (n: number) => (n === 1 ? "1 room" : `${n} rooms`),
    accSketchNote: "No floor plan for this one — the bed layout is schematic.",
